...
<style>
    ...
    .DivError {color: green;font-size: 22px;}
	...
	<div class="Container">
		<center>
		    <div id="GiayChungNhan_Div" class="GiayChungNhan_Div" style="">
    		    ...
    		    <canvas id="GiayChungNhan_Img" width="617" height="1000" style="display:none;">
                    
                </canvas>
                <canvas id="GiayChungNhan_Img2" width="309" height="500" style="">
                ...
                <input type="text" id="HoVaTen" class="InputBox" style="width:80%;margin-top:8px;" placeholder="Nhập họ tên của bạn tại đây" onkeyup="ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',617,1000);ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',309,500);">
                <input type="text" id="SoDienThoai" class="InputBox" style="width:80%;margin-top:8px;" placeholder="Số điện thoại" onkeyup="ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',617,1000);ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',309,500);">
                <input type="text" id="BienSoXe" class="InputBox" style="width:80%;margin-top:8px;" placeholder="Biển số xe" onkeyup="ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',617,1000);ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',309,500);">
            ...
            <div id="Menu_Header_Div" class="" style="width:100%;">
            ...
            <?php
                    ...
                    else
                    {
                        ...
                        $BienSoXe = '';
                        $HoVaTen = '';
                        $Tach = explode('kkkkkkkk',$_GET['hovaten']);
                        $HoVaTen = $Tach[0];
                        if (count($Tach >1)) {$SoDienThoai = $Tach[1];}
                        if (count($Tach >2)) {$BienSoXe = $Tach[2];}
                        
                        
                        $HoVaTen = str_replace('space',' ',$HoVaTen);
                        $SoDienThoai = str_replace('space',' ',$SoDienThoai);
                        $BienSoXe = str_replace('space',' ',$BienSoXe); ?>
                            
                        <input type="text" id="HoVaTen" value="<?php echo $HoVaTen; ?>" class="InputBox" style="width:80%;margin-top:8px;display:none;" placeholder="Nhập họ tên của bạn tại đây" onkeyup="ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',617,1000);ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',309,500);">
                        <input type="text" id="SoDienThoai" value="<?php echo $SoDienThoai; ?>" class="InputBox" style="width:80%;margin-top:8px;display:none;" placeholder="Số điện thoại" onkeyup="ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',617,1000);ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',309,500);">
                        <input type="text" id="BienSoXe" value="<?php echo $BienSoXe; ?>" class="InputBox" style="width:80%;margin-top:8px;display:none;" placeholder="Biển số xe" onkeyup="ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',617,1000);ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',309,500);">
            ...
            <script>
                ...
                {                
                    ...
                    ctx.font="bold " + parseInt(Rong0*Size/300)*TyLe + "px Times New Roman";
                    ...
                    base_image.onload = function()
                    {
                        ...
                        */
                        ...
                        ctx.font="bold " + parseInt(Rong0*Size/300 - Rong0/100)*TyLe + "px Times New Roman";
                        /*
                        ctx.fillStyle = "black";
                        ctx.fillText($('#SoDienThoai').val(), X1 + Rong0/900, Y1 + Rong0*15/300*TyLe+Rong0/900);
                        ctx.fillStyle = "white";
                        */
                        ctx.fillStyle = "white";
                        ctx.fillText($('#SoDienThoai').val(), X1, Y1 + Rong0*23/300*TyLe);
                        
                        ctx.fillText($('#BienSoXe').val().toUpperCase(), X1, Y1 - Rong0*38/300*TyLe);
                        var HVT = $('#HoVaTen').val().replace(/ /g,'spacespace');
                        var SDT = $('#SoDienThoai').val().replace(/ /g,'spacespace');
                        var BSX = $('#BienSoXe').val().replace(/ /g,'spacespace');
                        
                        var Link = "https://mlnd.pvcgo.net/card/7/index.php?hovaten=" + HVT + "kkkkkkkk" + SDT+ "kkkkkkkk" + BSX;
                        
                        var base_image2 = new Image();
                        base_image2.setAttribute('crossOrigin', 'anonymous');
                        var Qr_Width = 160*Rong/306;
                        base_image2.onload = function()
                        {
                            ctx.drawImage(base_image2, X1  - Qr_Width/2*TyLe, (Cao * 0.23)*TyLe,Qr_Width*TyLe,Qr_Width*TyLe);  
                        };
                        base_image2.src = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=" + Link + "&choe=UTF-8";
                        
                    }
                    base_image.src = 'card.jpg?vesion=2';
                    
                    
                        
                }
                ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',617,1000);
                ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',309,500);
            </script>       	    
		</center>
	</div>
