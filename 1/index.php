	...
	<div class="Container">
		<center>
		    <div id="GiayChungNhan_Div" class="GiayChungNhan_Div" style="">
    		    ...
    		    <canvas id="GiayChungNhan_Img" width="500" height="500" style="display:none;">
                    
                </canvas>
                <canvas id="GiayChungNhan_Img2" width="300" height="300" style="">
                ...
                <br>
                <input type="text" id="HoVaTen" class="InputBox" style="width:80%;margin-top:8px;" placeholder="Nhập họ tên của bạn tại đây" onkeyup="ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',500,500);ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',300,300);">
                <input type="text" id="SoDienThoai" class="InputBox" style="width:80%;margin-top:8px;" placeholder="Số điện thoại" onkeyup="ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',500,500);ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',300,300);">
            ...
            <script>
                ...
                {                
                    ...
                    ctx.font="bold " + parseInt(Rong0*Size/300)*TyLe + "px Time New Roman";
                    ...
                    base_image.onload = function()
                    {
                        ...
                        */
                        ...
                        //alert(Rong + 'dffdsf' + Cao)
                        
                        var X1= Rong/2 - Rong0*11/300*TyLe;
                        var Y1= Cao * 0.48;
                        ctx.fillText($('#HoVaTen').val().toUpperCase(), X1, Y1);
                        
                        ctx.font="bold " + parseInt(Rong0*Size/300 - Rong0/200)*TyLe + "px Time New Roman";
                        ctx.fillText($('#SoDienThoai').val(), X1, Y1 + Rong0*55/300*TyLe);
                        
                    }
                    base_image.src = 'card.jpg?vesion=10';
                }
                ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',500,500);
                ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',300,300);
            </script>       	    
		</center>
	</div>
