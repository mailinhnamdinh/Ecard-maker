		...
		<center>
            ...
            <script>
                ...
                {                
                    ...
                    ctx.font="bold " + parseInt(Rong0*14/300)*TyLe + "px MainFont";
                    ...
                    base_image.onload = function()
                    {
                        ...
                        */
                        ...
                        ctx.font="bold " + parseInt(Rong0*14/300 - Rong0/100)*TyLe + "px MainFont";
                        /*
                        ctx.fillStyle = "black";
                        ctx.fillText($('#SoDienThoai').val(), X1 + Rong0/900, Y1 + Rong0*15/300*TyLe+Rong0/900);
                        ctx.fillStyle = "green";
                        */
                        ctx.fillText($('#SoDienThoai').val(), X1, Y1 + Rong0*15/300*TyLe);
