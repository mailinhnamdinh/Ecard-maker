	...
	<div class="Container">
		<center>
		    <div id="GiayChungNhan_Div" class="GiayChungNhan_Div" style="">
    		    ...
    		    <canvas id="GiayChungNhan_Img" width="563" height="565" style="display:none;">
                    
                </canvas>
                <canvas id="GiayChungNhan_Img2" width="300" height="301" style="">
                ...
                <br>
                <input type="text" id="HoVaTen" class="InputBox" style="width:80%;margin-top:8px;" placeholder="Nhập họ tên của bạn tại đây" onkeyup="ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',563,565);ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',300,301);">
                <input type="text" id="SoDienThoai" class="InputBox" style="width:80%;margin-top:8px;" placeholder="Số điện thoại" onkeyup="ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',563,565);ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',300,301);">
            ...
            <script>
                ...
                {                
                    ...
                    base_image.onload = function()
                    {
                        ...
                        ctx.fillStyle = "white";
                        ctx.font="bold " + parseInt(Rong0*Size/300 - Rong0/60)*TyLe*1.2 + "px Times New Roman";
                        ctx.fillText($('#SoDienThoai').val(), X1, Y1 + Rong0*25/300*TyLe);
                    }
                    base_image.src = 'card.jpg?vesion=1';
                    
                    
                        
                }
                
                ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img',563,565);
                ShowChiTietDoiTuong_ChungNhanBaoHiem('GiayChungNhan_Img2',300,301);
            </script>       	    
		</center>
	</div>
